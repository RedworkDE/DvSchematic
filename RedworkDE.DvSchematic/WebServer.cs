...
#pragma warning restore 618
	...
	public class WebPage
	{
		...
		public void Register(Regex path, Action<HttpListenerContext, Match> handler)
		{
			if (path is null) throw new ArgumentNullException(nameof(path));
			if (handler is null) throw new ArgumentNullException(nameof(handler));
			HandleRequest += (context, uri) =>
			{
				var match = path.Match(uri.AbsolutePath);
		...
		public void Register(Regex path, Func<HttpListenerContext, Match, Task> handler)
		{
			if (path is null) throw new ArgumentNullException(nameof(path));
			if (handler is null) throw new ArgumentNullException(nameof(handler));
			HandleRequest += (context, uri) =>
		...
		public void Register(Regex path, Func<HttpListenerContext, Match, bool> handler)
		{
			if (path is null) throw new ArgumentNullException(nameof(path));
			if (handler is null) throw new ArgumentNullException(nameof(handler));
			HandleRequest += (context, uri) =>
